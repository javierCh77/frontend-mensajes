...
export default function UsuariosPage() {
  ...
  const [errores, setErrores] = useState<
    Partial<Record<keyof typeof nuevoUsuario, string>>
  >({});
    ...
    <div className="px-2">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between py-4 gap-4">
        <input
          ...
          className="border px-3 py-1 rounded-md w-full max-w-sm focus:outline-none focus:ring-2 focus:ring-[#25D366]"
          value={searchTerm}
          ...
          <tbody>
            {usuariosFiltrados.map((u) => (
              <tr key={u.id} className="border-t hover:bg-gray-50 text-center">
                ...
                <td className="px-6 py-2 text-xs text-gray-700 capitalize  ">
                  {u.rol}
                </td>
              </tr>
            ))}
        ...
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50">
          <div className="bg-[#eaecf4] p-6 rounded shadow-lg w-full max-w-3xl">
              ...
              {[
                ...
                <div key={name}>
                  ...
                  <input
                    ...
                    className={`border p-2 rounded bg-white w-full mt-1 ${
            ...
            <div className="flex justify-end gap-2 mt-6">
              <button
                onClick={resetModal}
                className="px-4 py-2 bg-gray-300 hover:bg-[#f5f6fa] cursor-pointer rounded-lg"
              >
                Cancelar
              </button>
              <button
